<script setup>
import { ResizablePanel, ResizablePanelGroup, ResizableHandle } from '@/runtime/components/ui/resizable'
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/runtime/components/ui/tabs'
import { Separator } from '@/runtime/components/ui/separator'
import { Button } from '@/runtime/components/ui/button'
import { ToggleGroup, ToggleGroupItem } from '@/runtime/components/ui/toggle-group'
