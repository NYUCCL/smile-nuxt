...
class Participant:
    ...
    def demographics(self) -> dict[str, Any] | None:
        ...
        Returns the most recent submission from pageData_demograph.
        """
    ...
    def device_info(self) -> dict[str, Any] | None:
        ...
        Returns the most recent submission from pageData_device.
        """
    ...
    def feedback(self) -> dict[str, Any] | None:
        ...
        Returns the most recent submission from pageData_feedback.
        """
    ...
    def git_repo(self) -> str:
        ...
        return self.github_info.get("repoName", "")
    ...
    @property
    def start_time_local(self) -> str | None:
        """Start time as local ISO string."""
        return self._data.get("starttimeLocal")
    ...
    @property
    def end_time_local(self) -> str | None:
        """End time as local ISO string."""
        return self._data.get("endtimeLocal")
    ...
    def plot_route_order(
        ...
        ax.plot(
            ...
            color=line_color, linewidth=2, solid_capstyle="round", zorder=1,
        )
        ...
        for i, (route, y_pos) in enumerate(zip(routes, y_positions)):
            ...
            if is_first or is_last:
                ax.scatter([x_line], [y_pos], s=node_size, c=node_color,
                           edgecolors=node_color, linewidths=2, zorder=3)
                if is_first:
                    ax.scatter([x_line], [y_pos], s=node_size * 0.15,
                               c="white", edgecolors="white", zorder=4)
            else:
                ax.scatter([x_line], [y_pos], s=node_size, c=node_fill,
                           edgecolors=node_color, linewidths=2, zorder=3)

            ax.text(x_text, y_pos, route_name, fontsize=10, fontweight="medium",
            ...
            if show_time_labels and has_timing:
                if time_delta is not None and time_delta > 0:
                    ...
                    time_str = ""
                if time_str:
                    ax.text(x_text, y_pos - 0.018, time_str, fontsize=8,
                            va="top", ha="left", color=muted_color)
