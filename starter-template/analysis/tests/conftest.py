...
def complete_participant_data() -> dict:
    ...
    return {
        ...
        "browserData": [
            {"event_type": "resize", "timestamp": 1700000000000},
        ],
        "studyData": [
        ...
        "pageData_demograph": {
            "visit_0": {
                "timestamps": [1700000001500],
                "data": [{"age": "25", "gender": "Male", "education_level": "Bachelor's"}],
            }
        },
        "pageData_device": {
            "visit_0": {
                "timestamps": [1700000001600],
                "data": [{"browser": "Chrome", "os": "macOS"}],
            }
        },
        "pageData_feedback": {
            "visit_0": {
                "timestamps": [1700000009000],
                "data": [{"difficulty": "moderate", "comments": "Good experiment"}],
            }
        },
        "pageData_trial": {
            "visit_0": {
...
def pagedata_only_participant_data() -> dict:
    """A participant with pageData-based forms (no studyData)."""
    return {
