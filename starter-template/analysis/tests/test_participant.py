...
class TestParticipantProperties:
    ...
    def test_github_info(self, participant):
        ...
        assert github["repoName"] == "my-experiment"
    ...
    def test_start_time(self, participant):
        ...
        assert participant.start_time == 1700000000000

    def test_start_time_local(self, participant):
        assert participant.start_time_local == "2023-11-14T12:00:00.000Z"

    def test_end_time(self, participant):
        assert participant.end_time is not None
        assert participant.end_time == 1700001000000

    def test_end_time_local(self, participant):
        assert participant.end_time_local == "2023-11-14T12:16:40.000Z"
